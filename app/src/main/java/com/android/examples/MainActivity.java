...
public class MainActivity extends AppCompatActivity
    ...
    protected void onStart() {
        ...
        intentFilter.addAction("com.android.examples.braodcast");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sendBroadcast(new Intent().setAction("com.android.examples.braodcast").putExtra("MSG", "Local Broadcast"));
            }
        });
        ...
        IntentFilter intentFilter = new IntentFilter("com.android.examples.braodcast");
    ...
    // to send broadcast from another activity .
